    ...
    [
        ...
        'columns'      => [
            [
                'name'  => 'sid',
                'type'  => 'raw',
                'value' => 'CHtml::link($data->sid, array("/user/userBackend/update", "id" => $data->id))',
            ],
            [
                'name'  => 'email',
                'type'  => 'raw',
            ...
            [
                'class'   => 'core\widgets\EditableStatusColumn',
                'name'    => 'status',
                'url'     => $this->createUrl('/user/userBackend/inline'),
            ...
            [
                ...
                'template'    => '{update}{password}{sendactivation}{delete}',
                'buttons'     => [
                    'password'       => [
