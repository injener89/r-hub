...
class UserManager extends CApplicationComponent
{
    ...
    protected function userNewSid(){    
        $criteria = new CDbCriteria(array(
                'order' => 't.sid DESC',
                'limit' => 1
            ));
           $userMaxSid = User::model()->find($criteria);
           return (int)$userMaxSid->sid+1;
    }
