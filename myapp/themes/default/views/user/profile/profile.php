<?php
$this->title = [Yii::t('UserModule.user', 'User profile'), Yii::app()->getModule('core')->siteName];
?>
...
<!--<div class="row">
    <div class="col-xs-6">
        <?php //$form->textFieldGroup($model, 'last_name') ?>
    </div>
</div>

<div class="row">
    <div class="col-xs-6">
        <?php //$form->textFieldGroup($model, 'first_name') ?>
    </div>
</div>

<div class="row">
    <div class="col-xs-6">
        <?php //$form->textFieldGroup($model, 'middle_name') ?>
    </div>
</div>-->
...
<!--<div class="row">
    <div class="col-xs-8">
        <?php //$form->textFieldGroup($model, 'location') ?>
    </div>
</div>

<div class="row">
    <div class="col-xs-8">
        <?php // $form->textFieldGroup($model, 'site') ?>
    </div>
</div>

<div class="row">
    <div class="col-xs-12">
        <?php /* $form->textAreaGroup(
            $model,
            'about',
