 ...
 *
 **/
class UserBackendController extends core\components\controllers\BackController
{
    ...
    public function actions()
    {
        return [
            'inline' => [
                'class'           => 'core\components\actions\YInLineEditAction',
                'model'           => 'User',
        ...
        if (($token = $tokenStorage->createEmailVerifyToken($user))) {
            ...
            Yii::app()->notify->send(
                ...
                Yii::t(
                    ...
                    ['{site}' => Yii::app()->getModule('core')->siteName]
                ),
