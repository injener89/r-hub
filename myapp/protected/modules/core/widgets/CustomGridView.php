...
class CustomGridView extends \TbExtendedGridView
{
   ...
   public $bottom_heager;
        ...
        $this->bulkActions = empty($this->bulkActions) ? [
            ...
            'actionButtons' => [
                [
                    ...
                    'context' => 'danger',
                    'size' => 'small',
                    'label' => Yii::t('CoreModule.core', 'Delete'),
    ...
    public function renderHeadline()
    {
        ...
        echo Yii::t('CoreModule.core', 'Display on');
        ...
        Yii::app()->getClientScript()->registerScript(
            ...
            'var multiaction' . $this->uid . ' = function (action, values) {
                ...
                $.ajax({
                    ...
                    error: function (data) {alert("' . Yii::t('CoreModule.core', 'Error!') . '")}
                });
            }',
