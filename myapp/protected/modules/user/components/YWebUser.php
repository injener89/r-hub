...
class YWebUser extends CWebUser
{
     ...
     * @since 0.8
     */
    public $rbacCacheNameSpace = 'core::user::rbac::';
     ...
     */
    public function getProfile($moduleName = 'core')
    {
     ...
     */
    public function getProfileField($field, $module = 'core')
    {
    ...
    protected function afterLogin($fromCookie)
    {
        ...
        if ($fromCookie) {
            ...
            try {
                ...
                $this->setState(self::STATE_SID, $user->sid);
