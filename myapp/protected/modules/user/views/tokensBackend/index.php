...
<?php $this->widget(
    ...
    [
        ...
        'columns'      => [
            ...
            [
                'name'        => 'status',
                'value'       => 'core\helpers\Html::label($data->status, $data->getStatus(), [UserToken::STATUS_NEW => core\helpers\Html::SUCCESS, UserToken::STATUS_ACTIVATE => core\helpers\Html::INFO, UserToken::STATUS_FAIL => core\helpers\Html::DANGER])',
                'type'        => 'raw',
