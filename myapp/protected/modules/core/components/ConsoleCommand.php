...
abstract class ConsoleCommand extends CConsoleCommand
{
    ...
    public function lock($time = 3600)
    {
        ...
        $this->getCache()->set(sprintf('core::command::run::%s', get_class($this)),'locked',(int)$time);
    }
    ...
    {
        $lock = $this->getCache()->get(sprintf('core::command::run::%s', get_class($this)));
    ...
    public function unlock()
    {
        ...
        $this->getCache()->delete(sprintf('core::command::run::%s', get_class($this)));
    }
