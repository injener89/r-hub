...
class qqFileUploader {
    ...
    public function getName(){
        ...
        $translit = array();
        $translit['ru'] = array('ё', 'й','ц','у','к','е','н','г','ш', 'щ', 'з','х','ъ','ф','ы','в','а','п','р','о','л','д','ж', 'э','я', 'ч', 'с','м','и','т','ь','б','ю', 'Ё', 'Й','Ц','У','К','Е','Н','Г','Ш', 'Щ', 'З','Х','Ъ','Ф','Ы','В','А','П','Р','О','Л','Д','Ж', 'Э','Я', 'Ч', 'С','М','И','Т','Ь','Б','Ю', ' ',',','\'','?');
        $translit['en'] = array('yo','y','c','u','k','e','n','g','sh','sh','z','h','', 'f','i','v','a','p','r','o','l','d','zh','e','ya','ch','s','m','i','t','y','b','yu','yo','y','c','u','k','e','n','g','sh','sh','z','h','', 'f','i','v','a','p','r','o','l','d','zh','e','ya','ch','s','m','i','t','y','b','yu','-','', ''  ,'' );
        
            if (isset($_REQUEST['qqfilename']))
            { return $this->fileNameId.'-='.strtolower(str_replace($translit['ru'], $translit['en'], $_REQUEST['qqfilename']));}

            if (isset($_FILES[$this->inputName]))
            {  return $this->fileNameId.'-'.$this->fileUploadDate.'.'.strtolower(str_replace($translit['ru'], $translit['en'], $_FILES[$this->inputName]['name']));} //
