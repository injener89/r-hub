...
class UpdateAction extends CAction
{
    ...
    {
        return $this->successMessage ?: Yii::t('CoreModule.core', 'Record was updated!');
    }

    protected function getErrorMessage()
    {
        return $this->errorMessage ?: Yii::t('CoreModule.core', 'Record was not found!');
    }
