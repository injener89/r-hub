 ...
 * @link http://websum.uz
 * @copyright 2009-2014 amyLabs && Websum team
...
class UserModule extends WebModule
{
    ...
    public $loginAdminSuccess = '/core/backend/index';
    ...
    public function getUploadPath()
    {
        ...
        Yii::app()->getModule('core')->uploadPath . '/' .
        $this->avatarsDir . '/';
    }
    ...
    {
        return Yii::t('UserModule.user', 'Websum team');
    }

    public function getAuthorEmail()
    {
        return 'team@websum.uz';
    }
