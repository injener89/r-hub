 ...
 * @package  core.modules.core.components.urlManager
 * @author   CoreTeam <team@websum.uz>
 * @license  BSD http://ru.wikipedia.org/wiki/%D0%9B%D0%B8%D1%86%D0%B5%D0%BD%D0%B7%D0%B8%D1%8F_BSD
 * @link     http://websum.uz
 */
namespace core\components\urlManager;
...
class LangUrlManager extends CUrlManager
{
    ...
    public function getAppLang()
    {
        if ($this->_appLang === false) {
            $this->_appLang = Yii::app()->getModule('core')->defaultLanguage;
        }
    ...
    public function loadLangs()
    {
        if (empty($this->languages)) {
            ...
            $this->langs = Yii::app()->getModule('core')->availableLanguages;
