...
class YFeedAction extends CAction
{
     ...
     *                 //'description'  => Yii::t('CoreModule.core', 'News list'),
    ...
    public function run()
    {
        ...
        Yii::import('application.modules.core.extensions.feed.*');
        ...
        if (count($this->data) > 0) {
             ...
             */
            if (!empty($this->itemFields['content'])) {
                $item->description = Yii::t('CoreModule.core', 'There is no records');
            }
