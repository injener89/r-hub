...
class CoreCommand extends \core\components\ConsoleCommand
{
    /**
     ...
     * Examples:
     *
     * yiic core updateConfig
     * yiic core updateConfig --modules=core
     * yiic core updateConfig --modules=core,comment,blog
     * yiic core updateConfig --modules=core --interactive=0
     *
     ...
     * Examples:
     *
     * yiic core updateMigrations
     * yiic core updateMigrations --modules=core
     * yiic core updateMigrations --modules=core,comment,blog
     * yiic core updateMigrations --modules=core --interactive=0
     *
     ...
     *
     * yiic core update
     * yiic core update --modules=comment
     * yiic core update --modules=comment,blog,catalog
     * yiic core update --modules=comment --interactive=0
     *
    ...
    public function actionFlushAssets()
    {
        ...
        foreach ($dirs as $value) {
            if (!\core\helpers\YFile::rmDir($value)) {
