<?php
/**
 * Класс core\widgets\YWidget - базовый класс для всех виджетов
 *
 * Все виджеты Websum должны наследовать этот класс
 * Основная особенность - view файлы для виджетов хранятся в каталоге "widgets" текущей темы, подробнее https://github.com/core/core/issues/26
 *
...
abstract class YWidget extends CWidget
{
    ...
    public function init()
    {
        if(!$this->cacheTime && $this->cacheTime !== 0) {
            $this->cacheTime = (int)Yii::app()->getModule('core')->coreCacheTime;
        }
