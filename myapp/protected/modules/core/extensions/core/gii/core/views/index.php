...
?>
<h1><?php echo Yii::t('CoreModule.core', 'Websum Generator!'); ?></h1>

<p><?php echo Yii::t('CoreModule.core', 'Websum Generator helps to create CRUD for any model.'); ?></p>

<p><?php echo Yii::t(
        'CoreModule.core',
        ' The resulting interface is well integrated into the control panel of Websum.'
    ); ?></p>

<p><?php echo Yii::t(
        'CoreModule.core',
        'More information and technical support you can find in our site {site}.',
        ['{site}' => CHtml::link(Yii::t('CoreModule.core', 'Websum'), 'http://websum.uz/?from=generator')]
    ); ?></p>
