...
class Migrator extends \CApplicationComponent
{
    ...
    {
        echo Yii::t('CoreModule.core', "Checking for pending migrations") . '<br />';
    ...
    protected function migrateUp($module, $class)
    {
        ...
        echo Yii::t('CoreModule.core', "Checking migration {class}", ['{class}' => $class]);
    ...
    {
        Yii::log(Yii::t('CoreModule.core', "Downgrade migration {class}", ['{class}' => $class]));
        $db = $this->getDbConnection();
        $start = microtime(true);
        $migration = $this->instantiateMigration($module, $class);
    ...
    protected function getDbConnection()
    {
        ...
        throw new CException(
            Yii::t('CoreModule.core', 'Parameter connectionID is wrong')
        );
    }
    ...
    public function getMigrationHistory($module, $limit = 20)
    {
        ...
        if ($allData === false || !isset($allData[$module])) {
            ...
            Yii::app()->getCache()->set(
                ...
                $allData,
                3600,
                new TagsCache('core', 'installedModules', 'getModulesDisabled', 'getMigrationHistory', $module)
            );
