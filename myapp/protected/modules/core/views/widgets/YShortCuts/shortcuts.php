<?php
/**
 * @var $this \core\widgets\YShortCuts
 * @var $modules \core\components\WebModule[]
 * @var $updates array
 */
?>
<div class="shortcuts">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('.config-update').on('click', function (event) {
            ...
            $.post('<?php echo Yii::app()->createUrl('/core/modulesBackend/configUpdate/')?>', {
                ...
                if (response.result) {
                    ...
                    $('#notifications').notify({
                        message: {text: '<?php echo Yii::t('CoreModule.core','Successful');?>'},
                        type: 'success'
                    }).show();
                }
