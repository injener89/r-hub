...
Компонент доступен из namespace'a `core\components\Migrator` и для своей работы использует следующие компоненты из глобального namespace'a:
...
[листинг](https://github.com/core/core/blob/master/protected/modules/core/components/Migrator.php#L38)
...
[листинг](https://github.com/core/core/blob/master/protected/modules/core/components/Migrator.php#L55)
...
[листинг](https://github.com/core/core/blob/master/protected/modules/core/components/Migrator.php#L210)
...
[листинг](https://github.com/core/core/blob/master/protected/modules/core/components/Migrator.php#L282)
...
[листинг](https://github.com/core/core/blob/master/protected/modules/core/components/Migrator.php#L345)
...
[листинг](https://github.com/core/core/blob/master/protected/modules/core/components/Migrator.php#L359)

<pre>@return db connection or make exception</pre>

### Метод getMigrationHistory - получаем историю миграций

[листинг](https://github.com/core/core/blob/master/protected/modules/core/components/Migrator.php#L382)
...
[листинг](https://github.com/core/core/blob/master/protected/modules/core/components/Migrator.php#L418)

<pre>@return nothing</pre>

### Метод getNewMigrations - проверка на наличие новых миграций для модуля

[листинг](https://github.com/core/core/blob/master/protected/modules/core/components/Migrator.php#L455)
...
[листинг](https://github.com/core/core/blob/master/protected/modules/core/components/Migrator.php#L496)
...
[листинг](https://github.com/core/core/blob/master/protected/modules/core/components/Migrator.php#L514)
